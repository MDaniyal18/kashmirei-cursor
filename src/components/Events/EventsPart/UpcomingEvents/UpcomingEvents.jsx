...
const upcomingEvents = [
  {
    ...
    day: "12",
    year: "2026",
    title: "KEI Annual Global Fundraising",
    location: "Online - Zoom/Teams",
    time: "1:00 PM EST",
    type: "Online",
    description: "Join us oline for inspiration, celebration, and community as we raise funds for KEI's 2027 programs.",
  ...
  },
  {
    ...
    time: "9:00 AM IST",
    type: "In-Person",
    description: "CMI’s FLY program is a four-day experiential learning workshop designed to cultivate five critical non-cognitive skills.",
    actionLabel: "Learn More",
    actionHref: "https://www.competitivenessmindset.org",
  },
  {
    id: 3,
    month: "Aug",
